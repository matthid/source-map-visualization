...
//type Function = Fable.Core.JsInterop.JsFunc
type Error = exn
type EngineFunc = Func<string, obj, Func<obj, string, unit>, unit>
...
module express =
    ...
    and IRouter<'T> =
        ...
        abstract all: name: U2<string, Regex> * [<ParamArray>] handlers: RequestHandler[] -> 'T
        abstract get: name: U2<string, Regex> * [<ParamArray>] handlers: RequestHandler[] -> 'T
        abstract post: name: U2<string, Regex> * [<ParamArray>] handlers: RequestHandler[] -> 'T
        abstract put: name: U2<string, Regex> * [<ParamArray>] handlers: RequestHandler[] -> 'T
        abstract delete: name: U2<string, Regex> * [<ParamArray>] handlers: RequestHandler[] -> 'T
        abstract patch: name: U2<string, Regex> * [<ParamArray>] handlers: RequestHandler[] -> 'T
        abstract options: name: U2<string, Regex> * [<ParamArray>] handlers: RequestHandler[] -> 'T
        abstract head: name: U2<string, Regex> * [<ParamArray>] handlers: RequestHandler[] -> 'T
    ...
    and Application =
        ...
        abstract engine: ext: string * fn: EngineFunc -> Application
        ...
        abstract listen: port: int * ?host: string * ?backlog: float * ?listeningListener:(unit -> unit) -> Http.Server
        abstract listen: path: string * ?listeningListener:(unit -> unit) -> Http.Server
        abstract listen: handle: Node.Net.Fd * ?listeningListener:(unit -> unit) -> Http.Server
        abstract listen: handle: obj * ?listeningListener:(unit -> unit) -> Http.Server
        ...
        //abstract listen: port: int * ?callback: Function -> Http.Server
    ...
    type Globals =
        abstract ``static`` : root:string * ?options: ``serve-static``.Options -> Handler
